using Blockage.Editor.ViewModels;
using System;
...
public class SlideGrid {
	...
	public int Width;
	public int Height;
	public ItemViewModel[] Grid;
	private ItemViewModel _Goal;

	private static readonly string EMPTY = ".";

	public void Init(int width, int height, List<ItemViewModel> items) {
		Won = false;
		Width = width;
		Height = height;
		Items = items;

		Grid = new ItemViewModel[Width * Height];
	...
	private bool BallOnGoal(ItemViewModel i) =>
		_Goal != null &&
		new ObjectType[]{ ObjectType.Ball, ObjectType.BallX, ObjectType.BallY }.Contains(i.Type) &&
		i.X == _Goal.X &&
		i.Y == _Goal.Y;
}
